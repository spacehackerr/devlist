...
2)	в абстрагировании от деталей реализации, путем сокрытия ненужных деталей реализации от клиента, используя инкапсуляцию. Вся работа с объектом ведется только через интерфейс.
